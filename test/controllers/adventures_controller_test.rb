...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post adventures_url, params: { adventure: { cost: @adventure.cost, description: @adventure.description, family_id: @adventure.family_id, title: @adventure.title } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { cost: @adventure.cost, description: @adventure.description, family_id: @adventure.family_id, title: @adventure.title } }
